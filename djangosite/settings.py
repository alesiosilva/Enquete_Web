...
SECRET_KEY = 'django-insecure-0q6h^_2@3e!@)if18e5g8huk&c+%vwf2el1ri$2=2deft*2zri'
...
TEMPLATES = [
    {
        ...
        'DIRS': [ BASE_DIR / 'djangosite/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DEFAULT_FROM_EMAIL = 'Django Site <allessyu@hotmail.com>'
EMAIL_USE_TLS = True
